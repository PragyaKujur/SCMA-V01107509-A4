...
survey_df<-read.csv("C:\\Users\\Home\\Downloads\\Survey (2).csv",header=TRUE) 
dim(survey_df) 
names(survey_df) 
head(survey_df) 
str(survey_df)
...
icecream_df<-read.csv('C:\\Users\\Home\\Downloads\\icecream.csv',header=TRUE)
dim(icecream_df)
...
#conjoint analysis
# Load data
df <- read.csv('C:\Users\Home\Downloads\pizza_data.csv')
